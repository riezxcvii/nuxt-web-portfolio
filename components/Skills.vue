<template>
    <div class="min-w-screen px-6 mb-8">
        <!-- skill category title -->
        <h1 class="text-white font-black uppercase tracking-wider my-0 text-xl w-fit rounded-lg cursor-default select-none">
            {{ categoryName }}
        </h1>
        ...
        <div>
            <ul
                ...
                <li v-for="skill in skillCategory" :key="skill.id" class="bg-white w-max text-black rounded-md md:px-4 px-3 py-2 select-none">
...
const skillCategory = ref(props.skillCategory);
