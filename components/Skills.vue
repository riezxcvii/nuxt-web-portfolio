<template>
    <div class="w-screen px-6">
        ...
        <h1 class="text-white font-black uppercase tracking-wider my-0 text-xl w-fit rounded-lg">
            {{ categoryName }}
        </h1>
        ...
        <div>
            <ul
                class="h-max py-4 mb-4 items-center mx-auto overflow-x-auto flex justify-start md:gap-6 gap-4">
